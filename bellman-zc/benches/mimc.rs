...
extern crate bellman_zc;
extern crate bellman_st;
extern crate bellman_ry;
...
impl<'a, E: Engine> Circuit<E> for MiMCDemo<'a, E> {
    ...
    #[bench]
    fn mimc_threadpool(b: &mut test::Bencher) {
        use rand::Rng;
...
impl<'a, E: Engine> Circuit<E> for MiMCDemo<'a, E> {
    ...
    #[bench]
    fn mimc_cpupool(b: &mut test::Bencher) {
        use rand::Rng;
        // This may not be cryptographically safe, use
        // `OsRng` (for example) in production software.
        let rng = &mut thread_rng();
